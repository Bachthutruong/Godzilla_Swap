  ...
  return () => {
    return {
      ...
      getInterface: async ({ chains, EventEmitter }) => {
        const { StaticJsonRpcProvider } = await import("./lib-JTJLJV6I.js");
        const { ProviderRpcError, ProviderRpcErrorCode } = await import("./dist-467KSXWL.js");
        const { default: WalletConnect } = await import("./esm-BWDQSKX4.js");
        let QRCodeModal = await import("./cjs-ZZLTBJB3.js");
        QRCodeModal = QRCodeModal.default || QRCodeModal;
        const { Subject, fromEvent } = await import("./esm5-5WL4SL2O.js");
        const { takeUntil, take } = await import("./operators-PXWLT4MM.js");
